...
export type LendingEventStorage = EntityStorage<LendingEvent>

export enum LendingEventDALIndex {
...
export function createLendingEventDAL(path: string): LendingEventStorage {
  return new EntityStorage<LendingEvent>({
    ...
    indexes: [
      {
        name: LendingEventDALIndex.ReserveTimestamp,
        key: [reserveKey, timestampKey],
      },
      {
        name: LendingEventDALIndex.ReserveTypeTimestamp,
